...
class SnliLabelMapper(LabelMapperBase):
    ...
    def __init__(self):
        self.raw_labels = ["neutral", "entailment", "contradiction"]
        self._map = {v: i for i, v in enumerate(self.raw_labels)}

        self._reverse_map = {i: v for i, v in enumerate(self.raw_labels)}
