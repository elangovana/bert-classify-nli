...
class Builder:
    ...
    def get_train_dataset(self):
        if self._train_dataset is None:
            self._train_dataset = ImdbDataset(self.train_data, preprocessor=self.get_preprocessor())

        return self._train_dataset

    def get_val_dataset(self):
        if self._val_dataset is None:
            self._val_dataset = ImdbDataset(self.val_data, preprocessor=self.get_preprocessor())
